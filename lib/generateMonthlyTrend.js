...
export const OPPORTUNITY_SEASONALITY_MAP = {
  // ========== ALL 카드 (P1~P5) ==========
  "P1-1": { type: "yearend_peak",    description: "연말 카드 정리 시점" },
  "P1-2": { type: "month_start",     description: "월말 실적 체크 피크" },
  "P1-3": { type: "month_start",     description: "월말 실적 피로 검색" },
  "P1-4": { type: "yearend_peak",    description: "연말 카드 교체 시점" },
  "P1-5": { type: "yearstart_peak",  description: "2026 카드 추천 1-3월" },
  "P1-6": { type: "month_start",     description: "고소비자 월말 정산" },

  "P2-1": { type: "yearend_peak",    description: "연말·연초 멤버십 갱신기" },
  "P2-2": { type: "yearstart_peak",  description: "연초 쿠팡와우 갱신" },
  "P2-3": { type: "cyclical",        description: "OTT·배달 월간 주기성" },
  "P2-4": { type: "cyclical",        description: "할인 구조 재점검 주기" },
  "P2-5": { type: "yearstart_peak",  description: "연초 자동납부 정리기" },

  "P3-1": { type: "cyclical",        description: "유튜브 프리미엄 갱신 주기" },
  "P3-2": { type: "surging",         description: "VPN 단속 이후 공식 전환" },
  "P3-3": { type: "surging",         description: "넷플릭스 가격 인상 +286%" },
  "P3-4": { type: "cyclical",        description: "OTT 갱신 주기" },
  "P3-5": { type: "explosive",       description: "유튜브 프리미엄 라이트" },
  ...
  "P4-3": { type: "cyclical",        description: "알리 세일기 (1111·618)" },
  "P4-4": { type: "cyclical",        description: "직구 세일기 주기성" },
  "P4-5": { type: "summer_peak",     description: "여름 여행 + 일상 해외 결제" },
  "P4-6": { type: "surging",         description: "개발자 AI 스택 확산" },

  "P5-1": { type: "yearstart_peak",  description: "연말정산 1월 10배 피크" },
  "P5-2": { type: "school_semester", description: "3·9월 신학기 청소년 카드" },
  ...
  "DAILY-COVER-4-1": { type: "cyclical",       description: "반려동물 월간 결제 주기" },
  "DAILY-COVER-5":   { type: "summer_peak",    description: "하이퍼로컬 맛집 주말·여름" },
  "DAILY-ACCENT-1":  { type: "surging",        description: "전기차 확산 +25%" },
  "DAILY-ACCENT-2":  { type: "cyclical",       description: "배달 매주 루틴" },
  "DAILY-ACCENT-3":  { type: "summer_peak",    description: "다이어트 식단 5-7월" },

  // ========== YOU Prime 가족팩 ==========
  "FAMILY-COVER-1-1": { type: "school_semester", description: "봄·가을 대청소·이사 피크" },
  "FAMILY-COVER-2-1": { type: "yearstart_peak",  description: "가계 통합 연초" },
  "FAMILY-COVER-3-1": { type: "school_semester", description: "학령기 신학기" },
  "FAMILY-COVER-4-1": { type: "cyclical",        description: "새벽배송 주간 주기" },
  "FAMILY-COVER-5":   { type: "yearstart_peak",  description: "펫보험 가입 연초 피크" },
  "FAMILY-COVER-6":   { type: "school_semester", description: "유치원 알리미 신학기" },
  "FAMILY-ACCENT-1":  { type: "summer_peak",     description: "여름 냉방비 피크" },
  "FAMILY-ACCENT-2":  { type: "yearstart_peak",  description: "연초 어린이보험" },
  "FAMILY-ACCENT-3":  { type: "surging",         description: "쿠팡 로켓프레시 +117%" },
  "FAMILY-ACCENT-4":  { type: "cyclical",        description: "코스트코 월 1-2회" },
  "FAMILY-ACCENT-5":  { type: "surging",         description: "세탁·청소 외주 +20%" },

  // ========== NEED Pay ==========
  "PAY-COVER-P1-1": { type: "month_start",     description: "네이버 월초 결제 집중" },
  "PAY-COVER-P2-1": { type: "yearstart_peak",  description: "연초 구독 다이어트" },
  "PAY-COVER-P3-1": { type: "cyclical",        description: "MZ 쇼핑 세일 주기" },
  "PAY-COVER-P4-1": { type: "month_start",     description: "페이 월초 결제 집중" },
  "PAY-COVER-P5":   { type: "yearend_peak",    description: "12-1월 여행 성수기 피크" },
  "PAY-ACCENT-1":   { type: "yearend_peak",    description: "연말 페이 선택 재점검" },
  "PAY-ACCENT-2":   { type: "yearstart_peak",  description: "연초 카드 정리기" },
  "PAY-ACCENT-3":   { type: "surging",         description: "네이버플러스 프로모션" },
  "PAY-ACCENT-4":   { type: "surging",         description: "토스페이 +31% 성장" },
  "PAY-ACCENT-5":   { type: "cyclical",        description: "배달·새벽배송 주간 주기" },

  // ========== NEED AutoSlim ==========
  "AUTOSLIM-COVER-A1-1": { type: "spring_car",   description: "2-4월 신차 출고 피크" },
  "AUTOSLIM-COVER-A2-1": { type: "month_start",  description: "주유비 월초 인지 패턴" },
  "AUTOSLIM-COVER-A3-1": { type: "semi_annual",  description: "여름·겨울 앞 정비" },
  "AUTOSLIM-COVER-A4-1": { type: "winter_peak",  description: "LPG 충전 겨울 피크" },
  "AUTOSLIM-ACCENT-1":   { type: "spring_car",   description: "신차 구매 전 탐색" },
