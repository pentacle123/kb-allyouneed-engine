...
export default function Home() {
  ...
  // Phase 12-17: prefetch 진행 상태 (현재는 사용 안 함 — 60s 제약으로 클라이언트 분할)
        ...
        {loading && (
          <div style={{
            ...
            <div style={{ fontSize: 11, color: C.textSoft }}>
              약 20-30초 소요 · Claude Sonnet 4.5 · 3개 아이디어 동시 생성
            </div>
            {ideasTab === "auto" && (
              <div style={{ fontSize: 10, color: C.textSoft, marginTop: 10, fontStyle: "italic" }}>
                💡 완료 후 스토리보드 3개도 백그라운드에서 자동 사전 생성됩니다
              </div>
            )}
          </div>
        )}
